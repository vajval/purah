...
//
//
//        MethodCheckResult autoFillCheckResult =(MethodCheckResult) customService.checkByCustomSyntaxWithMultiLevel(goodCustomUser);
//        assertFalse(autoFillCheckResult.isSuccess());
//        List<LogicCheckResult> resultList = autoFillCheckResult.logicResultList(ResultLevel.all);
//
////        for (LogicCheckResult baseLogicCheckResult : resultList) {
